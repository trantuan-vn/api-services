/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d362dbb68577a81bd3b7ac1d045b6112)
// Runtime types generated with workerd@1.20250913.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
        ...
        DEBUG: string;
        AI: Ai;
        INPUT_QUEUE: Queue; // input-part-0
        ERROR_QUEUE: Queue; // error-queue-dlq
        QUEUE_BATCH_SIZE: string;
        QUEUE_FLUSH_INTERVAL: string;
        QUEUE_FLUSH_THRESHOLD: string;
